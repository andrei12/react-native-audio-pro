...
import { useInternalStore } from "./useInternalStore.js";
...
export const AudioPro = {
  ...
  reactivateAudioSession() {
    logDebug('AudioPro: reactivateAudioSession()');
   ...
   */
  getProgressInterval() {
    return useInternalStore.getState().configureOptions.progressIntervalMs ?? DEFAULT_CONFIG.progressIntervalMs;
  },
  // ==============================
