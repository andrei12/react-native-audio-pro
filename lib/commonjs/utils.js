...
function validateTrack(track) {
  ...
  // 5. Artwork URL must be a valid URL if provided (optional)
...
function guardTrackPlaying(methodName) {
  if (!_useInternalStore.useInternalStore.getState().trackPlaying) {
...
function logDebug(...args) {
  if (_useInternalStore.useInternalStore.getState().debug) {
