...
var _useInternalStore = require("./useInternalStore.js");
...
function isValidPlayerStateForOperation(operation) {
  const {
    playerState
  } = _useInternalStore.useInternalStore.getState();
...
const AudioPro = exports.AudioPro = {
  ...
  configure(options) {
    ...
    (0, _utils.logDebug)('AudioPro: configure()', options);
  },
  /**
  ...
  play(track, options = {}) {
    ...
    if (resolvedTrack.artwork && typeof resolvedTrack.artwork !== 'string') {
      console.log('[react-native-audio-pro]: Artwork is not a string, resolving asset. Type:', typeof resolvedTrack.artwork, 'Value:', resolvedTrack.artwork);
      try {
        const resolved = _reactNative.Image.resolveAssetSource(resolvedTrack.artwork);
        console.log('[react-native-audio-pro]: Image.resolveAssetSource result:', resolved);
        resolvedTrack.artwork = resolved?.uri;
        console.log('[react-native-audio-pro]: Final resolved artwork URI:', resolvedTrack.artwork);
      } catch (error) {
      ...
      console.log('[react-native-audio-pro]: Artwork is already a string:', resolvedTrack.artwork);
    }
  ...
  reactivateAudioSession() {
    (0, _utils.logDebug)('AudioPro: reactivateAudioSession()');
    NativeAudioPro.reactivateAudioSession();
  },
  /**
   ...
   */
  getState() {
    return _useInternalStore.useInternalStore.getState().playerState;
  },
  /**
   ...
   */
  getPlayingTrack() {
    return _useInternalStore.useInternalStore.getState().trackPlaying;
  },
  /**
   ...
   */
  getPlaybackSpeed() {
    return _useInternalStore.useInternalStore.getState().playbackSpeed;
  },
  /**
   ...
   */
  getVolume() {
    return _useInternalStore.useInternalStore.getState().volume;
  },
  /**
   ...
   */
  getError() {
    return _useInternalStore.useInternalStore.getState().error;
  },
  /**
   ...
   */
  getProgressInterval() {
    return _useInternalStore.useInternalStore.getState().configureOptions.progressIntervalMs ?? _values.DEFAULT_CONFIG.progressIntervalMs;
  },
  // ==============================
